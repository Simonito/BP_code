...
class TransformerBlock(nn.Module):
    def __init__(self, in_dim: int, num_heads: int, cross_attn_ctx_dim: Optional[int] = None) -> None:
        super().__init__()
    ...
    def __init__(self,
        ...
        self.encoder_layers = nn.ModuleList([
            ...
            nn.ModuleList([
                ...
                TransformerBlock(128, num_heads=num_heads),
            ]),
            ...
            nn.ModuleList([
                ...
                TransformerBlock(256, num_heads=num_heads),
            ]),
        ...
        self.bottleneck = nn.ModuleList([
            ResBlock(512, 512, timestep_emb_dim=time_embed_dim),
            TransformerBlock(512, num_heads=num_heads),
            ResBlock(512, 512, timestep_emb_dim=time_embed_dim),
        ])
