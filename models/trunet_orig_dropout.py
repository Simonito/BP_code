...
class UNETR(nn.Module):
    def __init__(self,
        ...
        self.encoder_layers = nn.ModuleList([
            ...
            nn.ModuleList([
                ResBlock(512, 512, timestep_emb_dim=time_embed_dim, dropout=dropout),
                ResBlock(512, 512, timestep_emb_dim=time_embed_dim, dropout=dropout),
            ]),
        ])
        ...
        self.bottleneck = nn.ModuleList([
            ResBlock(512, 512, timestep_emb_dim=time_embed_dim, dropout=dropout),
            TransformerBlock(512, num_heads=num_heads, patch_size=patch_size, img_size=img_size // 8, dropout=dropout),
            ResBlock(512, 512, timestep_emb_dim=time_embed_dim, dropout=dropout),
        ])
        ...
        self.decoder_layers = nn.ModuleList([
            ...
            nn.ModuleList([
                ResBlock(512 + 512, 512, timestep_emb_dim=time_embed_dim, dropout=dropout),
                ResBlock(512, 512, timestep_emb_dim=time_embed_dim, dropout=dropout),
            ]),
            ...
            nn.ModuleList([
                ResBlock(64 + 64, first_channel, timestep_emb_dim=time_embed_dim, dropout=dropout),
            ]),
        ])
